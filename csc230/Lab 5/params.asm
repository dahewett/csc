...
; R30:R31
;
.def ZH=r31 ;sets up high byte and low byte of Z pointer
.def ZL=r30
		...
		ldi r16, 0xFF 
		sts SPL, r16	;loads 0xFF as stack pointer low byte
		ldi r16, 0x21
		sts SPH, r16	;loads 0x21 as stack pointer high byte 
						;Results in stack pointer of SP = 0x21FF
		...
		ldi r16, 0xEE 
		push r16		;loads 0xEE onto the stack (automatically incriments stack pointer)
		; push the second parameter
		ldi r16, 0xCC	;loads 0xCC onto the stack
		push r16
		call do_something	;Calls do_something (when using "call" pushes 3 pc onto the stack)
...
do_something:
		...
		push r0
		push r1
		; PUSHES THE 4 Registers onto the stack
